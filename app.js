...
// const compression = require('compression') // 响应压缩中间件 - 已禁用，使用 Nginx 的 Brotli 压缩
...
// 注意：响应压缩由 Nginx 层统一处理（使用 Brotli 压缩，比 gzip 更好）
// Nginx 已配置 Brotli 压缩，应用层不再压缩，避免重复压缩浪费 CPU
// 如果需要应用层压缩（例如开发环境没有 Nginx），可以取消下面的注释：
